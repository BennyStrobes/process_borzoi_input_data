...
def main():
	...
	# Added by Ben
	parser.add_option('-a', dest='autosomes_only',
		default=True, action='store_true',
		help='Use only autosomal chromosomes [Default: %default]')
	...
	# Get dictionary list of autosomal chromosomes
	autosomal_chroms = {}
	...
	for clength, chrom in length_chroms:
		...
		# Added by Ben (skip non-autosomal chromosomes)
		if options.autosomes_only and chrom not in autosomal_chroms:
			continue
